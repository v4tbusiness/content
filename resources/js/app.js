...
window.addEventListener("load", function () {
  if (document.getElementById("wysiwyg")) {
    ...
    const editor = new Editor({
      ...
      content: document.getElementById("wysiwyg-hiddenInput").value,
      editorProps: {
        attributes: {
          class:
      ...
      onUpdate: ({ editor }) => {
        document.getElementById("wysiwyg-hiddenInput").value = editor.getHTML();
      },
    });
    ...
    document
      ...
      .addEventListener("click", () => {
        const url = window.prompt("Enter image URL:", "https://google.com");
