        ...
        <form method="post" action="{{ route('payments.store') }}" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <x-text-input id="payment_method" class="mt-1 block w-full" type="text" name="payment_method"
                    :value="old('payment_method')" autofocus autocomplete="payment_method" required />
            ...
            <div>
                ...
                <x-text-input id="minimum_transaction" class="mt-1 block w-full" type="number"
                    name="minimum_transaction" :value="old('minimum_transaction', 0)" autocomplete="minimum_transaction" required
                    step="0.01" min="0.01" />
