<x-admin-layout>
    ...
    <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4 mt-6">
        <div class="flex items-center space-x-4">
            <a href="{{ route('contents.create') }}"
                ...
                Add New</a>
            <a href="{{ route('import') }}"
                class="flex items-center text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-600 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
    ...
    <div class="relative overflow-x-auto sm:rounded-lg">
        ...
        @if ($contents->isEmpty())
            <p class="text-center text-gray-500 my-4">No contents found.</p>
        @endif
