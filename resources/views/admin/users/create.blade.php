    ...
    <div class="max-w-xl">
        <form method="post" action="{{ route('users.store') }}" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <x-text-input id="telegram" class="mt-1 block w-full ps-10" type="text" name="telegram"
                        :value="old('telegram')" autocomplete="telegram" placeholder="username" />
                </div>
            ...
            <div>
                ...
                <x-text-input id="whatsapp" class="mt-1 block w-full" type="text" name="whatsapp" :value="old('whatsapp')"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <x-text-input id="coins" class="mt-1 block w-full ps-10" type="number" name="coins"
                        :value="old('coins', 0)" autocomplete="coins" required step="0.01" min="0" />
                </div>
