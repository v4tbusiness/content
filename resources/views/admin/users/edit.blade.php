    ...
    <div class="max-w-xl">
        <form method="post" action="{{ route('users.update', $user->id) }}" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <x-text-input id="name" class="mt-1 block w-full" type="text" name="name" :value="old('name', $user->name)"
            ...
            <div>
                ...
                <x-text-input id="username" class="mt-1 block w-full" type="text" name="username" :value="old('username', $user->username)"
            ...
            <div>
                ...
                <x-text-input id="email" class="mt-1 block w-full" type="email" name="email" :value="old('email', $user->email)"
            ...
            <div>
                ...
                <x-text-input id="password" class="mt-1 block w-full" type="password" name="password" :value="old('password', $user->password)"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <x-text-input id="telegram" class="mt-1 block w-full ps-10" type="text" name="telegram"
                        :value="old('telegram', $user->telegram)" autocomplete="telegram" placeholder="username" />
                </div>
            ...
            <div>
                ...
                <x-text-input id="whatsapp" class="mt-1 block w-full" type="text" name="whatsapp" :value="old('whatsapp', $user->whatsapp)"
                    autocomplete="whatsapp" placeholder="" />
                <x-input-error :messages="$errors->get('whatsapp')" class="mt-2" />
            </div>

            <div>
                <x-input-label for="coins">
                    {{ __('Coins') }} <span class="text-red-500">*</span>
                </x-input-label>
                <div class="relative">
                    <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                    ...
                    <x-text-input id="coins" class="mt-1 block w-full ps-10" type="number" name="coins"
                        :value="old('coins', $user->coins + 0)" autocomplete="coins" required step="0.01" min="0" />
                </div>
                <x-input-error :messages="$errors->get('coins')" class="mt-2" />
            </div>

            <div>
                <x-input-label for="access_level">
                    {{ __('Access Level') }} <span class="text-red-500">*</span>
                </x-input-label>
                <x-select-input id="access_level" class="mt-1 block w-full" name="access_level">
                    <option value="user" {{ $user->access_level == 'user' ? 'selected' : '' }}>user
                    </option>
                    <option value="admin" {{ $user->access_level == 'admin' ? 'selected' : '' }}>admin
                    </option>
                </x-select-input>
