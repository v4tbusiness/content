<x-admin-layout>
    ...
    <div class="max-w-xl">
        <form method="post" action="{{ route('packages.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
            @csrf
            ...
            <div>
                <x-input-label for="cover">
                    {{ __('Cover') }} <span class="text-red-500">*</span>
                </x-input-label>
                <x-file-input id="cover" type="file" name="cover" class="mt-1 block w-full" required
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <x-text-input id="price" class="mt-1 block w-full ps-10" type="number" name="price"
                        :value="old('price', 0)" autocomplete="price" required step="0.01" min="0" />
                </div>
