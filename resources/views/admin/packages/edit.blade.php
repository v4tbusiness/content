    ...
    <div class="max-w-xl">
        <form method="post" action="{{ route('packages.update', $package->id) }}" class="mt-6 space-y-6"
            ...
            <div>
                ...
                <x-text-input id="name" class="mt-1 block w-full" type="text" name="name" :value="old('name', $package->name)"
            ...
            <div>
                ...
                <x-text-input id="slug" class="mt-1 block w-full" type="text" name="slug" :value="old('slug', $package->slug)"
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                    ...
                    placeholder="" required>{{ old('description', $package->description) }}</textarea>
                <x-input-error :messages="$errors->get('description')" class="mt-2" />
            </div>

            <div>
                <x-input-label for="cover" :value="__('Cover')" />
                <x-file-input id="cover" type="file" name="cover" class="mt-1 block w-full"
                    onchange="previewImage(event)" />
                @if ($package->cover)
                    @if (Storage::disk('public')->exists($package->cover))
                        <img id="image-preview" src="{{ old('cover', asset('storage/' . $package->cover)) }}"
                            class="mt-2 h-auto max-w-full object-cover rounded-lg" />
                    @else
                        <img id="image-preview" src="{{ old('cover', $package->cover) }}"
                            class="mt-2 h-auto max-w-full object-cover rounded-lg" />
                    @endif
                @else
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <x-text-input id="price" class="mt-1 block w-full ps-10" type="number" name="price"
                        :value="old('price', $package->price)" autocomplete="price" required step="0.01" min="0" />
                </div>
