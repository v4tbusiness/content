...
<body class="font-sans antialiased">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="#" class="flex ms-2 md:me-24">
                        <img src="{{ asset($setting->logo) }}" class="h-8 me-3" alt="{{ $setting->site_name }}" />
                        <h1 class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <x-nav-link :href="route('contents.index')" :active="request()->routeIs('contents.index')">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Contents</span>
                    </x-nav-link>
                </li>
                <li>
    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="p-4 rounded-lg dark:border-gray-700 mt-14">
            ...
            <!-- Page Content -->
            <main class="max-w-7xl sm:px-6 lg:px-8">
                {{ $slot }}
            </main>
