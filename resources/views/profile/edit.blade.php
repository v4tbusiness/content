<x-user-layout>
    <x-slot name="title">
        {{ $setting->site_name }} - Edit Profile
    </x-slot>
    ...
    <x-slot name="meta">
        ...
        <meta property="og:title" content="{{ $setting->site_name }} - Edit Profile">
        ...
        <meta property="twitter:title" content="{{ $setting->site_name }} - Edit Profile">
